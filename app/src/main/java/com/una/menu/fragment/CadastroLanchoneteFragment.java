...
public class CadastroLanchoneteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_cadastro_lanchonete, container, false);

        // Recebe os ID's dos objetos da tela;
        editNomeCad         = view.findViewById(R.id.editNomeEdit);
        editTelefoneCad     = view.findViewById(R.id.editTelefoneEdit);
        editCelularCad      = view.findViewById(R.id.editCelularCad);
        editEnderecoCad     = view.findViewById(R.id.editEnderecoCad);
        ...
        btnCadastrar    = view.findViewById(R.id.btnEditarLanchonete);
                                ...
                                public void onCompleted(Exception e, JsonObject result) {
                                    ...
                                    try {
                                        if(RETORNO.equals("EMAIL_ERRO")){
                                            Toast.makeText(v.getContext(), "Este email já está cadastrado!", Toast.LENGTH_LONG).show();
                                        } else if (RETORNO.equals("SUCESSO")){
                                            Toast.makeText(v.getContext(), "Cadastro realizado com sucesso!", Toast.LENGTH_LONG).show();

                                            Intent abreLogin = new Intent(v.getContext(), PrincipalActivity.class);
